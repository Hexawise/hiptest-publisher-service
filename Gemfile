...
gem 'hiptest-publisher', '~> 1.21.0', git: 'https://github.com/Hexawise/hiptest-publisher.git' # Publisher for Hiptest projects https://github.com/hiptest/hiptest-publisher
